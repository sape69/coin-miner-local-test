...
// transactionId on turvallinen ja AdMobin odottamassa muodossa.
//
// AdMobin dokumentaation mukaan transaction_id on:
//
...
// ----------------------------------------------------------
//
// AdMob ad_network identifiers voivat olla hyvin pitkiä
// numeerisia merkkijonoja.
//
// Niitä EI muunneteta Number-tyyppiin, jotta precision
// ei katoa.
//
// ----------------------------------------------------------
...
rewardRef,
  ...
  if (
    ...
    //
    // Tärkeää:
    // Tämä ei anna mitään varsinaista rewardia.
    //
    // ----------------------------------------------------
  ...
  // rewarded = false
  //
  // Tämä funktio EI anna varsinaista rewardia.
  //
  // ======================================================
