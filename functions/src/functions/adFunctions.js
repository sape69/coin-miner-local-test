...
// --------------------------------------------------------
// Verified callback, mutta callbackin AdMob metadata ei
// vastaa Stelluriinin sallittua reward-rakennetta.
//
// Näitä ei saa yrittää käsitellä rewardina.
// --------------------------------------------------------
...
// ----------------------------------------------------------
//
// AdMobin ad_network voi olla erittäin suuri numeerinen
// identifier.
//
...
//
// Sen odotettu rakenne on:
//
// UID:rewardPurpose
//
// admobService.js:n pitää lisäksi kryptografisesti
// varmistaa callback ennen tämän funktion kutsua.
//
// ----------------------------------------------------------
...
rewardRef,
  ...
  transaction.set(
    rewardRef,
    {
      ...
      //
      // Tätä ei koskaan käytetä client-side rewardina.
      //
      signature,
