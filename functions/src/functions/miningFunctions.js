...
//
// IMPORTANT:
// Power Boost can only be created while the current mining
// cycle is active. Therefore a boost that belongs to the
// current cycle must have boostStartedAt inside that cycle.
//
// The query is intentionally restricted to the current
// mining-cycle start/end window. This prevents every mining
// calculation from loading the user's entire Power Boost
// history.
//
// The final JavaScript checks remain in place as a defensive
// validation layer.
// ============================================================
