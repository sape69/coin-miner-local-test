...
// Tärkeää:
//
// SSV-callbackit voivat viivästyä.
//
// Tämän vuoksi timestampia ei käytetä yksinään
// replay-suojauksena.
//
// Varsinainen idempotenssi perustuu transaction_id:hen
// ja Firestore-transaktioon.
//
// Sallitaan:
//
// - enintään 7 päivää vanha callback
...
// ============================================================
//
// Stelluriinin server-side odotetyt Ad Unit ID:t.
//
// HUOM:
//
...
//
// adFunctions.js tallentaa sen audit-tiedoksi.
//
// ============================================================
...
// ============================================================
//
// AdMob transaction_id on yksilöllinen
...
// ============================================================
//
// AdMob SSV käyttää ad_network-parametrina numeerista
...
function parseCustomData(
  ...
  // ----------------------------------------------------------
  //
  // Vain yksi ":" erotin sallitaan.
  //
  // UID ei itsessään saa sisältää ":" validateUid()-tarkistuksen
  // vuoksi, mutta reward purposeakaan ei saa sisältää ylimääräisiä
  // osia.
  //
  // ----------------------------------------------------------
  ...
  if (
    ...
    throw createError(
      "ADMOB_CUSTOM_DATA_MISSING",
      "AdMob custom_data contains an unexpected separator.",
    );
  }
...
async function verifyAdMobCallback(
  ...
  // ==========================================================
  //
  // Varmistetaan vielä, että normalisoitu custom_data
