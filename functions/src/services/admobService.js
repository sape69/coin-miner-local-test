...
// ============================================================
//
// Google dokumentoi, että:
//
// ...&signature=...&key_id=...
//
// ovat callbackin kaksi viimeistä
// query-parametria.
//
...
//   abc123:power_boost
//
// AdMobin custom_data voi olla percent-escaped,
// joten URLSearchParams tekee varsinaisen
// parametrin dekoodauksen ennen tätä funktiota.
//
...
// -muodossa.
//
// Sallitaan pieni kellopoikkeama, mutta erittäin
// vanhoja tai tulevaisuuteen sijoittuvia callbackeja
// ei hyväksytä.
//
// Tämä ei yksin estä replay-hyökkäystä.
// transaction_id:n Firestore-idempotency suojaa
// varsinaiselta uudelleenkäytöltä.
//
