...
class AppLocalizations {
  ...
  String get(String key) {
    final language = _translations[languageCode] ??
        _translations['fi']!;
  ...
  static const Map<String, Map<String, String>> _translations = {
    'fi': {
      ...
      'dailyAd': '📺 Päivittäinen palkinto näyttää mainoksen.',
      'logout': 'Kirjaudu ulos',
      'languageChanged': 'Kieli vaihdettu',
      'adLoading': 'Mainos latautuu. Odota hetki.',
      'adFailed': 'Mainosta ei voitu näyttää.',
      'dailyLimitReached':
    ...
    'en': {
      ...
      'watchAd': 'Watch ad',
      'watchAdReward': 'Watch an ad and receive +3 STL.',
      'today': 'Today',
      ...
      'sevenDayStreak': '🔥 7-day streak achieved!',
      'sevenDayReward':
          'You receive 7 STL every day until you miss a day.',
      'dailyAd': '📺 Daily Claim requires an ad.',
      'logout': 'Log out',
      'languageChanged': 'Language changed',
      'adLoading': 'The ad is loading. Please wait.',
      'adFailed': 'The ad could not be shown.',
      'dailyLimitReached':
    ...
    'sv': {
      ...
      'watchAdReward': 'Titta på en annons och få +3 STL.',
      'today': 'Idag',
      ...
      'sevenDayStreak': '🔥 7 dagars svit uppnådd!',
      'sevenDayReward':
          'Du får 7 STL varje dag tills du missar en dag.',
      'dailyAd': '📺 Den dagliga belöningen visar en annons.',
      'logout': 'Logga ut',
      'languageChanged': 'Språket ändrades',
      'adLoading': 'Annonsen laddas. Vänta.',
      'adFailed': 'Annonsen kunde inte visas.',
      'dailyLimitReached':
    ...
    'de': {
      ...
      'sevenDayStreak': '🔥 7-Tage-Serie erreicht!',
      'sevenDayReward':
          'Du erhältst jeden Tag 7 STL, bis du einen Tag verpasst.',
      'dailyAd': '📺 Die tägliche Belohnung zeigt eine Werbung.',
      'logout': 'Abmelden',
      'languageChanged': 'Sprache geändert',
      'adLoading': 'Werbung wird geladen. Bitte warten.',
      'adFailed': 'Die Werbung konnte nicht angezeigt werden.',
      'dailyLimitReached':
    ...
    'es': {
      ...
      'watchAd': 'Ver anuncio',
      'watchAdReward': 'Mira un anuncio y recibe +3 STL.',
      'today': 'Hoy',
      ...
      'sevenDayStreak': '🔥 ¡Racha de 7 días conseguida!',
      'sevenDayReward':
          'Recibes 7 STL cada día hasta que pierdas un día.',
      'dailyAd': '📺 La recompensa diaria muestra un anuncio.',
      'logout': 'Cerrar sesión',
      'languageChanged': 'Idioma cambiado',
      'adLoading': 'El anuncio se está cargando. Espera.',
      'adFailed': 'No se pudo mostrar el anuncio.',
      'dailyLimitReached':
    ...
    'fr': {
      ...
      'sevenDayStreak': '🔥 Série de 7 jours atteinte !',
      'sevenDayReward':
          'Vous recevez 7 STL chaque jour jusqu’à manquer un jour.',
      'dailyAd':
          '📺 La récompense quotidienne affiche une publicité.',
      'logout': 'Se déconnecter',
      'languageChanged': 'Langue modifiée',
      'adLoading': 'La publicité se charge. Veuillez patienter.',
      'adFailed': 'La publicité n’a pas pu être affichée.',
      'dailyLimitReached':
    ...
    'it': {
      ...
      'sevenDayStreak': '🔥 Serie di 7 giorni raggiunta!',
      'sevenDayReward':
          'Ricevi 7 STL ogni giorno finché non salti un giorno.',
      'dailyAd': '📺 La ricompensa giornaliera mostra un annuncio.',
      'logout': 'Esci',
      'languageChanged': 'Lingua cambiata',
      'adLoading': "L'annuncio si sta caricando. Attendi.",
      'adFailed': "L'annuncio non può essere mostrato.",
      'dailyLimitReached':
    ...
    'pt': {
      ...
      'sevenDayStreak': '🔥 Sequência de 7 dias alcançada!',
      'sevenDayReward':
          'Você recebe 7 STL todos os dias até perder um dia.',
      'dailyAd': '📺 A recompensa diária mostra um anúncio.',
      'logout': 'Sair',
      'languageChanged': 'Idioma alterado',
      'adLoading': 'O anúncio está carregando. Aguarde.',
      'adFailed': 'Não foi possível mostrar o anúncio.',
      'dailyLimitReached':
    ...
    'ja': {
      ...
      'watchEarn': '広告を見て獲得',
      'watchAd': '広告を見る',
      'watchAdReward': '広告を見ると +3 STL を獲得できます。',
      'today': '今日',
      'dailyLimit': '1日の上限',
      'loadingAd': '広告を読み込み中...',
      'wait': '待機',
      ...
      'claimed': '使用済み',
      'dailyReward': '今日の報酬',
      'sevenDayStreak': '🔥 7日連続達成！',
      'sevenDayReward':
          '1日休むまで毎日7 STLを獲得できます。',
      'dailyAd': '📺 デイリー報酬には広告が表示されます。',
      'logout': 'ログアウト',
      'languageChanged': '言語を変更しました',
      'adLoading': '広告を読み込んでいます。お待ちください。',
      'adFailed': '広告を表示できませんでした。',
      'dailyLimitReached':
          '1日の広告上限5/5に達しました。',
      'waitMessage': '待機',
      'pointsAdded': '+3 STL! 🐱',
    ...
    'zh': {
      ...
      'claimed': '已使用',
      'dailyReward': '今日奖励',
      'sevenDayStreak': '🔥 已连续7天！',
      'sevenDayReward':
          '只要不中断，每天可以获得7 STL。',
      'dailyAd': '📺 每日奖励会显示广告。',
      'logout': '退出登录',
      'languageChanged': '语言已更改',
      'adLoading': '广告正在加载，请稍候。',
      'adFailed': '无法显示广告。',
      'dailyLimitReached':
          '已达到每日广告上限5/5。',
      'waitMessage': '等待',
