...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final timestamp = data['lastAdTimestamp'];

      if (timestamp is Timestamp) {
        loadedLastAdTime = timestamp.toDate();
      }

      final oldLastAdTime = data['lastAdTime'];
